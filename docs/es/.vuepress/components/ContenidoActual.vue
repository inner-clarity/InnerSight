<template>
  <div class="contenido-actual"> 
    ...
    <ul>
      ...
      <li>Piensa que es un fetiche, una adiccion, un trauma pero este <router-link to="/analisis_psicologico_profundo.html">analisis profundo porque no así</router-link></li>
    </ul>
